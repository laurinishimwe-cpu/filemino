...
def get_job_service() -> JobService:
    ...
    queue = RedisRQQueue(redis_client, settings.cpu_queue_name, settings.gpu_queue_name)
    ...
    return JobService(repository, queue, limiter, settings.guest_max_jobs_per_hour, settings.guest_max_concurrent_jobs, settings.job_ttl_seconds,selector)
