...
def _job_to_payload(job: Job) -> dict[str, Any]:
    return {
        ...
        "image_conversion_ico_sizes": job.image_conversion_ico_sizes,
        "image_conversion_ico_source_size": job.image_conversion_ico_source_size,
...
def _job_from_payload(payload: dict[str, Any]) -> Job:
    ...
    return Job(
        ...
        image_conversion_ico_sizes=tuple(payload["image_conversion_ico_sizes"]) if payload.get("image_conversion_ico_sizes") else None,
        image_conversion_ico_source_size=payload.get("image_conversion_ico_source_size"),
