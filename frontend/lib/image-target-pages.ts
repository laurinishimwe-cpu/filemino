...
const sharedFaqs: TargetSizeFaq[] = [
  {
    ...
    answer: "FileMino supports JPG, PNG, and WebP. PNG transparency is preserved when keeping PNG or choosing WebP.",
  },
  {
...
function targetFaq(targetKb: number, qualityNote: string): TargetSizeFaq[] {
  return [
    ...
    },
    {
      ...
      answer: "FileMino first searches for the best quality at the target. If needed, it can reduce dimensions while keeping the original aspect ratio.",
    },
    ...sharedFaqs,
  ];
}
...
export const imageTargetPages = [
  ...
  page(50, "A 50 KB target works well for lightweight forms, profile images, and quick attachments. The available quality depends on image dimensions and how much visual detail it contains.", "Often, but not universally. FileMino chooses the highest practical quality at or below 50 KB, and may reduce dimensions when quality changes alone cannot meet the target."),
